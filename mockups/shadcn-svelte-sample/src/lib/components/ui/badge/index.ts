...
export const badgeVariants = tv({
  ...
  variants: {
    variant: {
      default: "border-neutral-200 bg-neutral-100 text-black dark:border-coolgray-300 dark:bg-coolgray-200 dark:text-white",
      ...
      outline: "border-neutral-300 bg-transparent text-black dark:border-coolgray-300 dark:text-white",
