...
export const dropdownMenuContentClass =
  "absolute top-full z-50 mt-1 min-w-max max-w-[calc(100vw-1rem)] rounded-sm border border-neutral-300 bg-white p-1 shadow-sm outline-none dark:border-coolgray-300 dark:bg-coolgray-200";
