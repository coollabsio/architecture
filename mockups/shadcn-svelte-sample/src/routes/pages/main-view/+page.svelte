<script lang="ts">
  ...
  const resourceSections: SubSidebarItem[] = [
    { label: "Environment", href: `${base}/pages/main-view`, active: true },
    { label: "Deployments", href: `${base}/pages/main-view` },
    { label: "Commands", href: `${base}/pages/main-view` },
    { label: "Logs", href: `${base}/pages/main-view` },
    { label: "Metrics", href: `${base}/pages/main-view` },
    { label: "Settings", href: `${base}/pages/main-view` }
  ];
</script>
    ...
    {#if view === 'grid'}
      <div class="mx-auto w-full max-w-5xl py-4">
        ...
        <div class="mt-4 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          <Coolbox href={`${base}/pages/main-view`} title="Production API" description="Application · 3 containers">
            <div class="mt-2"><Badge variant="success">Running</Badge></div>
          </Coolbox>
          <Coolbox href={`${base}/pages/main-view`} title="Postgres" description="Database · backups enabled">
            <div class="mt-2"><Badge variant="warning">Restarting</Badge></div>
          </Coolbox>
          <Coolbox href={`${base}/pages/main-view`} title="Redis Queue" description="Service · worker cache">
            <div class="mt-2"><Badge>Idle</Badge></div>
          </Coolbox>
          <Coolbox href={`${base}/pages/main-view`} title="Create resource" description="Application, database, or service" />
        </div>
      </div>
    {:else if view === 'split'}
