...
Secure-area instruction callout, password field, and highlighted Confirm password button.
...
- Mockup reference: `mockups/shadcn-svelte-sample/src/routes/pages/confirm-password-page/+page.svelte`
