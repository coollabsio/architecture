---
version: alpha
name: Coolify Reset Password Page
description: Password reset auth page with password confirmation and password rules guidance.
colors:
  page-light: "#f9fafb"
  base: "#101010"
  surface: "#ffffff"
...
Instruction text, password/password-again fields, password rules callout, tall highlighted submit button, and Back to Login link.
