---
version: alpha
name: Coolify Forgot Password Page
description: Password reset request auth page with email field, email-disabled warning, and back-to-login action.
colors:
  page-light: "#f9fafb"
  base: "#101010"
  surface: "#ffffff"
...
- Mockup reference: `mockups/shadcn-svelte-sample/src/routes/pages/forgot-password-page/+page.svelte`
